...
public class NashornHelper {
	...
	//due to a design flaw this is not part of the public API and therefor the below workaround is needed
	private static Object undefined = null; 
	
	@SuppressWarnings("deprecation")
	public static synchronized Object getUndefinedValue() {	
		if (undefined == null) {
